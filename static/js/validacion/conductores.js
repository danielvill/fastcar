...
// Para limitar entrada celular
function limitarEntrada() {
    let x = document.getElementById("micelu");
    if (x.value.length > 10) {
        x.value = x.value.slice(0, 10);
    }
}
// Para limitar entrada Celular de emergencia
function limitarEntrada() {
    let x = document.getElementById("emecelu");
    if (x.value.length > 10) {
        x.value = x.value.slice(0, 10);
    }
}
